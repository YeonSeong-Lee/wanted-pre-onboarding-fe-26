...
/**
 * Fetches a paginated set of mock data.
 *
 * @param pageNum - The page number to fetch. Pages start from 1.
 * @returns A promise that resolves to an object containing:
 * - `datas`: An array of `MockData` objects for the requested page.
 * - `isEnd`: A boolean indicating whether the end of the data has been reached.
 *
 * @example
 * ```typescript
 * getMockData(1).then(({ datas, isEnd }) => {
 *   console.log(datas); // Logs the data for page 1
 *   console.log(isEnd); // Logs whether this is the last page
 * });
 * ```
 */
